...
class Module_Tryout extends Module
{
    ...
    public function install()
    {
        ...
        $fields[] = array('name'=>'Judul', 'slug'=>'judul', 'type'=>'text', 'required' => true, 'unique' => false, 'instructions' => 'Judul Paket Try Out', 'extra'=>array("max_length"=>"50", "default_value"=>""));
        $fields[] = array('name'=>'Deskripsi', 'slug'=>'deskripsi', 'type'=>'textarea', 'required' => true, 'unique' => false, 'instructions' => 'Deskripsi dari Paket Try Out', 'extra'=>array("default_text"=>"", "allow_tags"=>"y", "content_type"=>"text"));
